...
export default function LiveTracker() {
  const { locations, lastChecked, secondsRemaining, progressPct } = useLiveTrackerContext();

  return (
    <div
      id="live-tracker"
      className="rounded-md border border-black/10 bg-surface/60 px-4 sm:px-5 py-4 mt-6 scroll-mt-24 overflow-hidden"
    >
